...
%% define bandpass filter with 3 freq bands
...
gain2 = 1;
gain3 = 0.01;
final_filter = (gain1*y_high1)+(gain2*y_band2)+(gain3*y_low3); %three bandpass filters in parallel
sound(final_filter,fs);


%% code for other bands (if needed)
